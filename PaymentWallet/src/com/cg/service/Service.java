...
public class Service implements ServiceInterface
{
	...
	public Customer makeDeposit (String mobile, double amount) throws AccountNotFoundException, InvalidInputException
	{
		...
		Date date = new Date ();
		Transaction transaction = new Transaction (mobile, amount, "Deposit", customer.getWallet ().getBalance (), date);
																				 ...
																				 InvalidInputException
	{
		...
		Date date = new Date ();
		Transaction fromTransaction = new Transaction (to, amount, "Transfer, out", fromWallet.getBalance (), date);
		Transaction toTransaction = new Transaction (from, amount, "Transfer, receive", toWallet.getBalance (), date);
