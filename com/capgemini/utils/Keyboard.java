...
public class Keyboard
{
	...
	public static int readInt (String prompt)
	{
		...
		{
			Logging.LOG.error (ERROR.INTEGER);				// Conversion fails log error
	...
	public static float readFloat (String prompt)
	{
		...
		{
			Logging.LOG.error (ERROR.FLOAT);				// Conversion fails log error
	...
	public static double readDouble (String prompt)
	{
		...
		{
			Logging.LOG.error (ERROR.DOUBLE);					// Conversion fails log error
	...
	public static LocalDate readDate (String prompt)
	{
		...
		{
			Logging.LOG.error (ERROR.DATE_FORMAT);	// Conversion fails, log error
			return readDate (prompt);				// Ask for input again
		}
		catch (DateTimeException dte)
		{
			Logging.LOG.error (ERROR.DATE);			// Invalid date, log error
			return readDate (prompt);				// Ask for input again
		}
	...
	public static int menuInput (String title, String menu [])
	{
		...
		{
			Logging.LOG.error (ERROR.OPTION);						// If user input out of range log error
